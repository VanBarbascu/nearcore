...
class NodeHandle:
    ...
    def neard_runner_new_test(self, genesis_protocol_version, epoch_config_overrides):
        params = self.node.new_test_params(genesis_protocol_version, epoch_config_overrides)
